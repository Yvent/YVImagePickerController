...
class YVImageEditorController: UIViewController ,YVNavigationViewDelegate, UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    private func initUI()  {
        ...
        imageCollV.register(WSImageEditorCollVCell.self, forCellWithReuseIdentifier: "WSImageEditorCollVCell")
...
//                    print("\(imageArrCopt)")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "WSImageEditorCollVCell", for: indexPath) as! WSImageEditorCollVCell
